...
<div class="page-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="modal-body">
                <!--div class="input-group"-->
                      <span class="input-group-addon" style="width:380px">对象内容</span>
                      <textarea id="objtextA" name="objtextA" onkeyup="this.value=this.value.replace(/[^\d.\-\/\\\n]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d.-\/\\\n]/g,'')" placeholder="IP组: IP地址/IP段(一行一个)" style="width:380px;height:100px;resize:vertical;">{{info.get('objtext','')}}</textarea>
                      <textarea id="objtextB" name="objtextB" onkeyup="this.value=this.value.replace(/[^\w\d.\-\/\\\n]/g,'')" onafterpaste="this.value=this.value.replace(/[^\w\d.-\/\\\n]/g,'')" placeholder="域名组: domain.com(一行一个)" style="width:380px;height:100px;resize:vertical;">{{info.get('objtext','')}}</textarea>
                 <!--/div-->
		   </div>    
