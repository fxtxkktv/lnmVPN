%rebase base position='文件下载', managetopli="help"
<div class="page-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-themesecondary">
                    ...
                    <span class="widget-caption themesecondary">文件下载</span>
		...
		<div style="padding:-10px 0px;" class="widget-body no-padding">
		  ...
		  <p style="line-height: 5px;">&emsp;</p>
		  <p><span>&emsp;想要获取更多好的资源，请联系<a href="mailto:{{session.get('admemail','')}}">{{session.get('admemail','')}}</a></span></p>
		  <p style="line-height: 5px;">&emsp;</p>
		</div>
            </div>
        </div>
