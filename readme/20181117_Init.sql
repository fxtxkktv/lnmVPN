...
CREATE TABLE `sysinfo` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=51964 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sysroute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3792 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='ç”¨æˆ·è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vpnpolicy` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=100036 DEFAULT CHARSET=utf8 COMMENT='部门表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `vpnservconf`
--

DROP TABLE IF EXISTS `vpnservconf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vpnservconf` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `servmode` varchar(8) DEFAULT NULL,
  `authtype` int(2) DEFAULT NULL,
  `ipaddr` varchar(15) DEFAULT NULL,
  `servport` int(5) DEFAULT NULL,
  `virip` varchar(15) DEFAULT NULL,
  `virmask` varchar(15) DEFAULT NULL,
  `maxclient` int(4) DEFAULT NULL,
  `maxuser` int(4) DEFAULT NULL,
  `authtimeout` int(6) DEFAULT NULL,
  `authnum` int(3) DEFAULT NULL,
  `locktime` int(6) DEFAULT NULL,
  `comp` int(2) DEFAULT NULL,
  `cisco` int(2) DEFAULT NULL,
  `workstatus` int(2) DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2018-11-17 10:49:50
-- MySQL dump 10.13  Distrib 5.1.73, for redhat-linux-gnu (x86_64)
--
-- Host: localhost    Database: lnmdb
-- ------------------------------------------------------
...
INSERT INTO `sysattr` VALUES ('vpnprofile','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n<AnyConnectProfile xmlns=\"http://schemas.xmlsoap.org/encoding/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://schemas.xmlsoap.org/encoding/ AnyConnectProfile.xsd\">\r\n\r\n        <ClientInitialization>\r\n                <UseStartBeforeLogon UserControllable=\"false\">false</UseStartBeforeLogon>\r\n                <StrictCertificateTrust>false</StrictCertificateTrust>\r\n                <RestrictPreferenceCaching>false</RestrictPreferenceCaching>\r\n                <RestrictTunnelProtocols>IPSec</RestrictTunnelProtocols>\r\n                <BypassDownloader>true</BypassDownloader>\r\n                <WindowsVPNEstablishment>AllowRemoteUsers</WindowsVPNEstablishment>\r\n                <CertEnrollmentPin>pinAllowed</CertEnrollmentPin>\r\n                <CertificateMatch>\r\n                        <KeyUsage>\r\n                                <MatchKey>Digital_Signature</MatchKey>\r\n                        </KeyUsage>\r\n                        <ExtendedKeyUsage>\r\n                                <ExtendedMatchKey>ClientAuth</ExtendedMatchKey>\r\n                        </ExtendedKeyUsage>\r\n                </CertificateMatch>\r\n\r\n                <BackupServerList>\r\n                    <HostAddress>221.125.142.132</HostAddress>\r\n                     <HostAddress>221.125.142.132:4433</HostAddress>\r\n                </BackupServerList>\r\n        </ClientInitialization>\r\n\r\n        <ServerList>\r\n                <HostEntry>\r\n                    <HostName>KTC_HKOffice</HostName>\r\n                    <HostAddress>221.125.142.132</HostAddress>\r\n                </HostEntry>\r\n        </ServerList>\r\n</AnyConnectProfile>',1,'sys'),('vpnrelay','tun1000',0,'vpnrelay'),('dnsconf','{\"dnsrelay\": \"1\", \"dnsrule\": \"1\", \"dnsport\": 53, \"dnslist\": \"8.8.8.8\\n8.8.4.4\", \"dnsproxy\": \"1\", \"dnsstatus\": 0}',1,'dnsmasq'),('vpnclient','{\"authtype\": \"2\", \"ipaddr\": \"jp.vipin.us\", \"servport\": \"443\", \"service\": \"off\", \"chkconn\": \"1\"}',1,'openconnect'),('resData','{\"visitDay\":1,\"ResState\":\"True\",\"ResSaveDay\":30,\"ResInv\":30}',1,'sys'),('dhcpconf','{\"getdns1\": \"8.8.8.8\", \"getdns2\": \"8.8.4.4\", \"startip\": \"192.168.1.100\", \"dhcplist\": \"00:50:56:B7:05:1C,192.168.1.2\\n00:50:56:B7:05:1D,192.168.1.3\", \"getgw\": \"192.168.1.1\", \"dhcpenable\": \"1\", \"stopip\": \"192.168.1.200\"}',1,'dnsmasq');
